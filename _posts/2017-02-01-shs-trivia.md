...
<figure>
  ...
  <figcaption>
    기존 스한스 대문자로 이뤄진 문장과 스한스 2.0 대문자로 이뤄진 문장<br>
    기존 스한스 대소문자로 이뤄진 문장과 스한스 2.0으로 이뤄진 문장
  </figcaption>
</figure>
...
단, 모든 대문자를 원래 상태로 돌린 건 아니였습니다. 대문자 Q는 디자인의 변화를 겪었습니다. 

<figure>
  <img src="/images/2017-02-01/sds2.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    노토산스 대문자 Q와 스한스 2.0 대문자 Q
  </figcaption>
</figure>

소문자 y의 꼬리 또한 마찬가지 이유로 커브를 쫙 펴주는 작업을 해주었습니다. 
노토산스 CJK KR에 심긴 영문은 한글의 형태를 고려하여 디자인된 게 아니고 기존에 있던 오픈산스를 그대로 가져와 옮겨심은 것이기 때문에 아무래도 완벽하게 매칭된 상태는 아닙니다. 한글은 다소 딱딱한 느낌이 들었던 반면 오픈산스는 비교적 둥글둥글한 느낌을 받았습니다. 라토 서체에서 커스텀해 옮겨온 숫자 글리프도 쭉쭉 뻗은 모양새입니다. 
처음 스포카 한 산스 커스텀 작업을 하면서, 소문자 l의 꼬리 끝을 과감히 잘라낸 이유 중 하나도 한글 및 숫자 글리프와는 어울리지 않았기 때문입니다. 
...
<figure>
  <img src="/images/2017-02-01/sds3.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    노토산스 소문자 l과 스한스 2.0 소문자 l<br>
    노토산스 소문자 y과 스한스 2.0 소문자 y<br>
    위의 모든 글리프가 모두 포함된 영어 단어, 혹은 문장을 각각 노토산스와 스한스2.0으로
  </figcaption>
</figure>

숫자와 함께 쓰인 영문 예시 도판을 보시면 더 설득될지도 모르겠습니다. 

<figure>
  <img src="/images/2017-02-01/sds33.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    Q l y 를 모두 포함한 영단어와 숫자를 섞어쓴 예시 각각 노토와 스한스 2.0
  </figcaption>
</figure>
...
<figure>
  <img src="/images/2017-02-01/sds33.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    큰따옴표와 온점, 반점, 물음표, 숫자 비교 : 노토 산스, 스한스2.0, Apple 산돌고딕 Neo
  </figcaption>
</figure>
...
<figure>
  <img src="/images/2017-02-01/sds6.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    “ij.,?” 비교 : 노토 산스, 스한스2.0, Apple 산돌고딕 Neo 2 
  </figcaption>
</figure>
...
<figure>
  <img src="/images/2017-02-01/sds8.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    소문자 a가 들어간 단어 비교 : 노토 산스와 스한스2.0
  </figcaption>
</figure>
...
일단 노토산스의 숫자를 보면, 한글이나 영문 속에서 섞여 있을 땐 글줄이 매끈하게 썩 잘 어울리지만 숫자만 떼어놓고 보았을 때는 가독성이 다소 떨어지는 게 사실입니다. 

<figure>
  <img src="/images/2017-02-01/sds9.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    스포카 한산스와 노토산스, 영문 문자속에 섞인 숫자 예시.
  </figcaption>
</figure>
...
<figure>
  <img src="/images/2017-02-01/sds10.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    스포카 한 산스와 노토산스, 숫자만 나와있는 예시. 
  </figcaption>
</figure>

기존 스포카 한 산스는 형태에 대한 커스텀은 라토를 가져옴으로 해결했지만 자폭에 대한 고려는 하지 못했습니다. 왜냐하면 각 숫자 글리프의 형태가 단순한 1부터 양옆으로 빵빵한 8에 이르기까지 다양했고기때문에 각 숫자의 공간을 동일하게 주기 어려웠기 때문입니다. 
...
<figure>
  <img src="/images/2017-02-01/sds13.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    노토산스/라토/스한스1/스한스2 각각의 숫자14 글리프 모양 비교
  </figcaption>
</figure>
...
<figure>
  <img src="/images/2017-02-01/sds14.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    노토산스 light, bold 눈사람 글리프+메리크리스마스 문구와 스한스 2.0 light, bold 눈사람 글리프+메리크리스마스 문구
  </figcaption>
</figure>
...
한글과 일본어, 숫자를 주로 사용하는 서비스 특성에 맞춰, 숫자와 관련된 기호를 영문 소문자 디센더를 상대적으로 덜 고려한 위치로 옮겼습니다. 

<figure>
  <img src="/images/2017-02-01/sds16.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    스포가 한 산스 2.0과 노토, 각각 한글과 언더바를 섞어쓴 예시와 영문 대소문자와 언더바를 섞어 쓴 예시 
  </figcaption>
</figure>
...
<figure>
  <img src="/images/2017-02-01/sds19.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    엔대시가 포함된 노토산스 영문 글 한 단락과 스한스 한단락 
  </figcaption>
</figure>
...
키보드에 '<', '>'는 사실 수식의 부등호란 사실 알고 계셨나요?(…) 나 또한 스포카 한 산스 커스텀 하면서 알게 된 사실입니다. 허나 이미 수많은 사람이 이를 괄호처럼 사용하고 있으므로, 이게 괄호처럼 쓰여도 과히 이상해 보이지 않았으면 했고 이를 반영한 결과가 다음과 같습니다. 물론 수학 부등호와 괄호를 분명히 구분해주는 것이 맞지만, 많은 사람들이 귀찮고 특수문자를 찾아 넣기 힘들다는 이유로 혼용하고 있기 때문에 이를 무시할 수 없다고 생각했습니다.[^1] 참고로 과거의 나와 많은 사람이 <, >와 혼용하는 이 부호의 명칭은 꺾쇠괄호 혹은 홑화살괄호 〈 〉라고 합니다. 
...
<figure>
  <img src="/images/2017-02-01/sds23.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    shs | Spoqa | Seoul 스한스로 쓴것과 noto | Spoqa | Seoul 노토로 쓴것 
  </figcaption>
</figure>
...
<figure>
  <img src="/images/2017-02-01/sds27.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    ( ) { } [ ] 사이에 한글/영문단어 대소문자 섞어서/ 숫자 노토와 스한스 비교 
  </figcaption>
</figure>
...
<figure>
  <img src="/images/2017-02-01/sds28.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    ※ 〶 ‹ › « » 『 』 「 」 『 』 「 」 《 》 〈 〉이 한글이나 영문, 숫자와 섞인 도판 노토, 스한스2.0 각 자족별로 비교 
  </figcaption>
</figure>
...
<figure>
  <img src="/images/2017-02-01/sds31.png"
    style="margin-right:auto; margin-left:auto;" />
  <figcaption>
    스한스1.0 글리프 ?, 숫자 4의 패쓰 찌그러진것과 스한스 2.0에서 말끔해진 패스 비교
  </figcaption>
</figure>
...
"스포카"를 검색하면 가장 먼저 뜨는 연관검색어는 스포카의 서비스인 "도도 포인트"가 아니고 "스포카 한 산스"입니다. 또한 스포카에서 진행한 오픈소스 프로젝트 중 가장 흥한 프로젝트는 스포카 한 산스 프로젝트. (라고 개발자분들이 말씀해주심) 
...
### 17)
한번은 스포카 한 산스 적용 중에 생긴 문제 해결을 위해 자사에서 사용 중인 개발 디테일을 알려달라는 메일이 오기도 했었습니다. 이에 개발 디테일은 공개할 수 없다고 답변드리자 스포카 한 산스 프로젝트 전체를 총체적으로 폄하하는 메일을 받기도... 오픈소스 프로젝트에 대한 견해나 이해도 차이가 낳은 헤프닝이라고 생각합니다. 
...
### 19)
인기였던 어비스리움 앱에서도 스포카 한 산스 서체를 쓰고 있습니다.


### 20)
스포카 한 산스 프로젝트를 하고 나서, 이따금 내가 처음부터 만들지도 않은 서체를 우리 회사 이름을 붙이고 적극적으로 홍보하는 것에 대해 가끔은 떳떳하지 않은 기분을 느꼈습니다. 나는 서체 디자이너가 아니고, 아무리 우리가 쓰기 좋게 만들었다 한들 서체만을 전문으로 디자인하는 전문가 입장과는 상충할 수밖에 없다고 생각했습니다. 커스텀 퀄리티에 대해 자신이 없기도 했고요. 

다행히 최근에 한글타이포그래피학교에서 진행하는 안삼열 님의 섞어짜기 특강을 들을 기회가 생겼고 나는 우리 방향성 자체가 틀리지 않음을 확신했습니다.[^5] 한글과 영문을 함께 쓴다는것은 두 문명의 충돌이기에 모든 조건에 100% 만족하게끔 섞어 쓰는 건 어려운 일이고, 어떻게 서로를 "길들"일지는 디자이너의 선택에 따라 방향이 달라질 수 있는 것이지요. 어떤 의도로, 무엇에 초점을 맞춰 서로를 길들일지 판단하는 것은 디자이너의 몫인 것입니다. 

스포카 한 산스가 어디에 주로 쓰일 것인지 명확했고, 철저히 그 조건에 부합하려고 노력했습니다. 노토산스CJK KR은 한글을 디자인한 디자이너가 영문이나 기타 글리프를 디자인한 게 아니고 오픈산스를 그대로 가져와 붙인 것입니다. 물론 한글과 영문을 함께 쓰기에 부족함이 없도록 노력한 흔적들이 많고, 디자이너라면 이를 잘 찾아 적용할 수 있을 겁니다. 하지만 일반인들이 이를 알기는 힘들며, 앞서 말했듯 범용 애플리케이션에서 적용하기엔 어려운 점이 있습니다. 그럼에도 불구하고 노토산스 cjk kr는 장점이 압도적인 서체이고, 감사하게도 오픈소스로 풀리는 바람에 우리 같은 아마추어도 서체를 새로 만드는 수고에 비해 아주 적은 노력만을 들여 개조할 수 있었습니다. 우리가 개발자 문화에 친숙했고, 오픈소스란 개념이 낯설지 않았던 덕택에 이런 문명의 혜택(?)을 입을 수 있었던 것입니다. 

나는 이 프로젝트가 일종의 "리메이크"에 가깝다고 느낍니다. 상황에 맞게 기성 음악을 믹싱해서 틀거나 원하는 의도대로 리메이크 하듯, 우리도 서체를 리메이크한 것이지요. 
...
**Technical assistance :** 양천웅, 홍민희, 문성원
...
[^5]: 안삼열 님의 실제 의견과 나의 의견이 다를 수 있습니다. 
