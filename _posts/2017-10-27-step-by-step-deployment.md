...
서비스를 만드는 회사나 팀에서는 많은 경우 애자일, 린 등의 방법론을 실천하기 위해 노력합니다. 하지만 실무를 진행하다 보면 여러 가지 상황들이 이런 방법론을 수행하려는 우리를 샛길로 빠지게 합니다. 추정시간은 이미 예측을 벗어났고, 목표했던 배포 날짜도 한참 지나가 버립니다. 

이번 포스팅에서는 저희가 서비스 배포 주기를 최적화하기 위해 어떤 과정을 거쳤는지, 어떤 방식을 사용하여 개선했는지를 실사례를 들어 소개합니다.
