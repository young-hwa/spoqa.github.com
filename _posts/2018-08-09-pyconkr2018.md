...
[방 탈출 카페][]에 가보신 적이 있으신가요? 이번에 저희가 준비한 첫 번째 이벤트는, 이런 방 탈출 카페를 웹 브라우저로 옮긴 [회의실 탈출][]입니다. 360도 카메라로 촬영한 실제 스포카 회의실을 배경으로 한 이 게임은, 각개 각소에 있는 단서를 모아서 회의실에서 탈출하는 것이 목표입니다.

<p align="center">
  <img src="/images/2018-08-08/room-escape.png" width="2000px" />
</p>

이 게임은 파이콘 한국 이벤트 전에 공개됩니다. 게임을 클리어 하신 분들은 파이콘 행사 당일 저희 부스에서 **스티커 모음**을 받아가실 수 있습니다.

<p align="center">
  <img src="/images/2018-08-08/sticker.png" width="2000px" />
</p>


## 도도 파이터

[도도 파이터][]는 [철권][]이나 [스트리트 파이터][]와 같은 대전 격투 게임입니다. 제한된 시간 안에 상대 플레이어를 공격해서 체력을 0으로 만드는 쪽이 승리합니다. 다만 사람이 플레이를 직접 하는 것이 아니라 파이썬 코드를 통해 봇(bot)들이 실력을 겨룬다는 점이 다릅니다.
...
이렇게 작성된 코드들로 조별 예선과 토너먼트를 통해 우승자를 가리게 됩니다. 대회하면 상품이 빠질 수 없겠죠. 결선 토너먼트 우승자와 가장 참신한 코드를 작성해주신 분에게는 **해피 해킹 키보드 프로2**를 드립니다.
...
파이콘은 다른 기술 컨퍼런스들처럼 재능 있는 연사들의 영감 있는 발표를 접할 좋은 기회입니다. 하지만 그 뿐만이 아니라, 참가자들이 직접 오픈 소스 프로젝트에 참여할 수 있는 스프린트나 파이썬에 대해 배워 볼 수 있는 튜토리얼, 그리고 자유롭게 의견을 나눌 수 있는 라이트닝 토크가 열립니다. 이번 스프린트에는 저희가 만들어오고 있는 오픈 소스 RPC 프레임워크인 [니름][]의 스프린트도 있으니 관심 있으신 분들은 꼭 들러주세요.
...
<p>
  <img src="/images/2018-08-08/cable-tie.png" width="2000px" />
</p>
<p>
  <img src="/images/2018-08-08/lens-cleaner.png" width="2000px" />
</p>


당일 부스에는 스포카에서 실제 제품 개발 업무를 담당하고 계신 프로그래머, 디자이너, 기획자 분들이 계실 예정입니다. 스포카 채용에 대해서나, 제품 개발 과정에 대해 궁금하신 부분이 있다면 언제든지 편히 들러서 이야기 걸어주세요.
